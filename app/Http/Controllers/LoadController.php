...
class LoadController extends Controller
{
    ...
    {           
        ...
        $validated = $request->validate([
            ...
            "pickup_company_address2" =>'nullable|string',
            "pickup_company_city" => 'required|string',
            "pickup_company_state" => 'required|string',
            "pickup_company_zipcode" => 'required|numeric|min:5',
            ...
            "drop_off_company_address2" => 'nullable|string',
            "drop_off_company_city" => 'required|string',
            "drop_off_company_state" => 'required|string',
            "drop_off_company_zipcode" => 'required|numeric|min:5',
        ...
        return redirect(route('broker-load'))->with("status", "Load created successfully!");
    }
