@extends('layouts.authDashboard.auth-app')
@section('content')
<!-- Content -->
                ...
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">Truck App</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email"
                                placeholder="Ex: johndoe@gmail.com" value="{{ old('email') }}" />
                        </div>
                        @error('email')
                        <div class="form-control alert alert-danger">
                            {{ $message }}
                        ...
                        <div class="mb-3 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="password" class="form-control" name="password_confirmation"
                                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                    aria-describedby="password" value="{{ old('Confirm Password') }}" />
                                <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                            </div>
                        </div>
                        ...
                        @enderror
                        <div class="mb-3 form-password-toggle">
                            <label class="form-label" for="type-of-account">Type of
                                Account
                            </label>
                            <div class="input-group input-group-merge">
